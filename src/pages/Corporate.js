...
function Corporate() {
    ...
    function courseData() {
        axios.get("http://localhost:3006/api/viewcorporatecourse")
            .then((response) => {
    ...
    <header class="py-2 bg-dark  border-bottom mb-4">
        <div class="container">
            <div class="text-center my-5">
                <h1 class="fw-bolder" id='retailheading'>CORPORATE COURSES</h1>
                    ...
                    <div class="col-lg-6">
                        ...
                        <div class="card mb-4">
                            ...
                            <div class="card-body">
                                ...
                                <Link class="btn btn-primary" to={`/corporate/singlecourse/${course._id}`}>Read more →</Link>
                            </div>
                        </div>
            ...
            <div class="col-lg-4">
                ...
                <div class="card mb-4">
                        ...
                        <div class="card-body" style={{display: 'flex',alignItems: 'center', textAlign: 'center'}}>
                            ...
                            <Link to="/retail" class="nav-item nav-link">Retail</Link>
                            <Link to="/insti" class="nav-item nav-link">Institutional</Link>
                            <Link to="/corporate" class="nav-item nav-link">Corporate</Link>
